...
bfile="/cbica/home/wenju/Reproducibile_paper/BrainAge/output/GWAS/muse/genotype/genotype"
...
if [[ -f ${output_file}.fastGWA ]]; then
  ...
  echo "GWAS for ${organ}..."
  sparse_grm=/cbica/home/wenju/Reproducibile_paper/BrainAge/output/GRM_GCTA/fastGWA_grm_sparse_0.05_muse
