...
#SBATCH --job-name=LDSC_munge_disease_clock
#SBATCH --array=0-46
...
file="${base_dir}/${organ_dir}/fastGWA/output/organ_pheno_normalized_residualized.fastGWA.ldsc.tsv"
output_file="${base_dir}/${organ_dir}/fastGWA/output/organ_pheno_normalized_residualized.fastGWA.ldsc"

echo "SLURM job ID: ${SLURM_JOB_ID}"
echo "Array task ID: ${SLURM_ARRAY_TASK_ID}"
echo "Output prefix: ${output_file}"

bash /cbica/home/wenju/Project/whole-body_clocks/LDSC_disease/ldsc_munge_stat.sh "${file}" "${output_file}"
