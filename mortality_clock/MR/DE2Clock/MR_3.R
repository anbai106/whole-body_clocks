...
write.table(res_mr,file=paste(output_dir, "/MR_", pheno1, "_2_", pheno2, ".tsv", sep=""),row.names=F,col.names=T,sep="\t",quote=F)
res_mr_or <- generate_odds_ratios(res_mr)
write.table(res_mr_or,file=paste(output_dir,  "/MR_", pheno1, "_2_", pheno2, "_OR.tsv", sep=""),row.names=F,col.names=T,sep="\t",quote=F)
