...
output_dir="/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/mortality_clock/GCTA_h2/${organ}_metabolomics_mortality_clock"
mkdir -p ${output_dir}
cd $output_dir
...
out_name=${organ}
grm=/cbica/home/wenju/Reproducibile_paper/UKBB_metabolomics/data/GRM_GCTA/fastGWA_grm_sparse_0.05
