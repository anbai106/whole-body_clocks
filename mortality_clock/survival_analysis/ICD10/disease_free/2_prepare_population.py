...
def prepare_data(disease):
    ...
    output_tsv = '/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/mortality_clock/SA/data/' + disease + '_diagnosis_clock_disease_free.tsv'
    if not os.path.exists(output_tsv):
        ...
        ### strict disease to define pure disease-free CN
