...
#SBATCH --job-name=SA_cum_EPOCH_test
#SBATCH --array=0-3572
#SBATCH --mem-per-cpu=12G
#SBATCH --time=0-05:59:00
#SBATCH --output=/cbica/home/wenju/output/SA_cum_EPOCH_test_%A_%a.out
#SBATCH --error=/cbica/home/wenju/output/SA_cum_EPOCH_test_%A_%a.err

# STEP 3 TEST-ONLY cumulative survival analysis for 11 proteomics + 4 metabolomics
...
OUT_DIR="${OUT_DIR:-/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/mortality_clock/SA/output_cumulative_EPOCH_PM/disease_free_test_only_cv}"
RUNNER="${RUNNER:-/cbica/home/wenju/Project/whole-body_clocks/mortality_clock/survival_analysis/ICD10/disease_free/cumulative_epoch_survival_pipeline/testdata_only/run_3_cumulative_epoch_survival_test_only.sh}"
PYTHON_SCRIPT="${PYTHON_SCRIPT:-/cbica/home/wenju/Project/whole-body_clocks/mortality_clock/survival_analysis/ICD10/disease_free/cumulative_epoch_survival_pipeline/testdata_only/survival_analysis_cumulative_mortality_epoch_test_only.py}"
...
OUTPUT_TSV="${OUT_DIR}/cox_cumulative_EPOCH_PM_test_only_${ICD}.tsv"
RANK_TSV="${OUT_DIR}/rank_order_EPOCH_PM_test_only_${ICD}.tsv"
AUDIT_TSV="${OUT_DIR}/audit_EPOCH_PM_test_only_${ICD}.tsv"
...
export PYTHON_SCRIPT RANK_P_THRESHOLD RANK_SORT_MODE NON_SIG_ORDER CV_FOLDS MIN_CASE MIN_NONCASE PENALIZER COVARIATE_SET ADMIN_CENSOR_DATE OVERWRITE TEST_SPLIT_COL TEST_SPLIT_VALUE
