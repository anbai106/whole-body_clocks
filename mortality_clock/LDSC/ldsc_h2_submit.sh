...
output_file=/cbica/home/wenju/Reproducibile_paper/UKBB_metabolomics/gc/${organ}/${organ}_h2
bash /cbica/home/wenju/Project/UKBB_NMR_metabolomics/LDSC/ldsc_h2.sh ${stat_gz1} ${output_file}
