#!/usr/bin/env python3
"""
General organ proteomics mortality clock using elastic-net Cox survival modeling.
...
Output naming is controlled by --organ, e.g. --organ heart creates:
  heart_proteomics_mortality_clock_predictions.tsv
  heart_proteomics_mortality_clock_performance.json
  etc.
"""
...
def output_prefix(organ):
    return f"{organ}_proteomics_mortality_clock"
...
def main():
    ...
    print(f"Building {organ} proteomics mortality clock")
