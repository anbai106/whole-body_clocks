...
df_protein_long = pd.read_csv(
    '/Users/hao/cubic-home/Reproducibile_paper/UKBB_Proteomics/imputation_3_0/UKBB_preoteomics_real_data_all_ancestry_with_related_indi_4_autocomplete_final_imputation_3_0.tsv',
    sep='\t')
...
for organ in organ_list:
    ...
    if set(protein_list_bl).issubset(protein_set_long):
        ...
        df_organ.to_csv(os.path.join(output_dir, 'proteimics_' + organ + '_3_0.tsv'), index=False, sep='\t')
    else:
        print('Organ: %s' % organ)
        print(
