...
for (organ in organ_list) {
  ## split1
  output_dir_final = paste(output_dir, organ, 'split1', sep='/')
  data_src = paste(output_dir, organ, 'split1', 'BAG_pheno.txt', sep='/')
  cov_src = paste(output_dir, organ, 'split1', 'BAG_cov.txt', sep='/')
  lm_imaging_data(data_src, cov_src, output_dir_final)

  ### split2
  print(paste0("Organ: ", organ))
  output_dir_final = paste(output_dir, organ,  'split2', sep='/')
  data_src = paste(output_dir, organ,  'split2', 'BAG_pheno.txt', sep='/')
  cov_src = paste(output_dir, organ,  'split2', 'BAG_cov.txt', sep='/')
  lm_imaging_data(data_src, cov_src, output_dir_final)
}
