...
#SBATCH --output=/cbica/home/wenju/output/sex_sample_%A_%a.out
#SBATCH --error=/cbica/home/wenju/output/sex_sample_%A_%a.err
...
do
    ...
    pheno="${input_dir}/${organ}/${sex}/BAG_pheno_normalized_residualized_with_related_indi.phen"
    ...
    if [[ -f ${output_file}.fastGWA ]]; then
      ...
      bash /cbica/home/wenju/Project/UKBB_NMR_metabolomics/fastGWA/BAG/split_sex/4_runGWAS/run.sh $output_dir $bfile $sparse_grm $pheno $output_file
    fi
done