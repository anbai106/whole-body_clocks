...
organ_list = c("Metabolic")
output_dir = '/Users/hao/cubic-home/Reproducibile_paper/UKBB_metabolomics/fastGWA_MetBAG/data/R1_sex_pooled/'

for (organ in organ_list) {
  ## female
  output_dir_final = paste(output_dir, paste0(organ, "_non_derived_", 'female'), sep='/')
  ...
  output_dir_final = paste(output_dir, paste0(organ, "_non_derived_", 'male'), sep='/')
  data_src = paste(output_dir_final, 'BAG_pheno.txt', sep='/')
  cov_src = paste(output_dir_final, 'BAG_cov.txt', sep='/')
  lm_imaging_data(data_src, cov_src, output_dir_final)
}
