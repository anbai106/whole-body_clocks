...
input_dir="/cbica/home/wenju/Reproducibile_paper/UKBB_metabolomics/data"
...
bfile="${input_dir}/metabolite_binary"
pheno="/cbica/home/wenju/Reproducibile_paper/UKBB_metabolomics/fastGWA_MetBAG/data/${organ}/BAG_pheno_normalized_residualized_with_related_indi.phen"
...
if [[ -f ${output_file}.fastGWA ]]; then
  ...
  bash /cbica/home/wenju/Project/UKBB_NMR_metabolomics/fastGWA/BAG/4_runGWAS/run.sh $output_dir $bfile $sparse_grm $pheno $output_file
fi