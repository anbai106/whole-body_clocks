...
output_dir=/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/GCTB/${organ}_mri_mortality_clock
mkdir -p $output_dir

source_file=/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/mortality_clock/fastGWA/output/${organ}_mri_mortality_clock/organ_pheno_normalized_residualized.fastGWA
