...
run_one_organ <- function(organ_label) {
  ...
  ggsave(
    file.path(outdir, paste0(organ_clean, "_metabolomics_mortality_z_distribution_by_case_status.svg")),
    p_dist,
    width = 13.5,
    height = 6.2
  )
  ...
  cat("  ", paste0(organ_clean, "_metabolomics_mortality_z_distribution_by_case_status.pdf/png/svg"), "\n")
