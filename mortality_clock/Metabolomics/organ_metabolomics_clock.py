...
def main():
    ...
    dataset_cols = ["participant_id", "baseline_date", "sample_date", "death_date", "admin_censor_date", "end_date", "time_days", "time_years", "event", "age_at_baseline", "age_at_imaging", "sex"]
    ...
    def make_pred_frame(part, split, risk):
        base = ["participant_id", "sample_date", "death_date", "admin_censor_date", "end_date", "time_years", "event", "age_at_baseline", "age_at_imaging", "sex"]
