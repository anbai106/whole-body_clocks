...
### Brain proteomics EPOCH-BAG residual
for organ in ['Brain']:
    tsv = '/Users/hao/cubic-home/Reproducibile_paper/WholeBodyClock/Brain_proteomics_mortality_clock/brain_proteomics_BAG_EPOCH_discordance_resilience.tsv'
    df_data = pd.read_csv(tsv, sep='\t')
    df_data.rename({'EPOCH_BAG_discordance_residual_z': 'EPOCH'}, axis=1, inplace=True)
    df_data = df_data[['participant_id', 'EPOCH']]
    cov_tsv = '/Users/hao/cubic-home/Reproducibile_paper/PRS_UKBB/prediction/data/UKBB_fullsample_covariate.csv'
    output_dir = os.path.join("/Users/hao/cubic-home/Reproducibile_paper/WholeBodyClock/mortality_clock/fastGWA/data", organ + "_proteomics_mortality_clock", "EPOCH_BAG_residual")
