...
### details of the 210 full matrics: https://pmc.ncbi.nlm.nih.gov/articles/PMC7280786/
...
output_dir=/cbica/home/wenju/Reproducibile_paper/SleepAging/NSS/BWAS/Brain/FC
mkdir -p $output_dir

output_file="${output_dir}/NSS_logistic_results_${idp}.tsv"
if [ ! -f ${output_file} ]; then
  echo "Run GAMLSS for: ${idp}..."
  bash /cbica/home/wenju/Project/SleepAging/NSS/BWAS/Brain/FC/fit_logistic.sh ${sleep_dir} ${idp_tsv} ${output_dir} ${idp} ${cov_tsv}
else
  :
fi
