...
#
# Input pattern:
#   /cbica/home/wenju/Reproducibile_paper/WholeBodyClock/*_mi_clock/fastGWA/output/*fastGWA
#
# Output:
#   /cbica/home/wenju/Reproducibile_paper/WholeBodyClock/<clock_folder>/fastGWA/qmplot/
#
# Recommended:
#   bash submit_qmplot_mi.slurm
#
# Or directly:
#   sbatch submit_qmplot_mi.slurm
# ============================================================
...
PROJECT_DIR="${PROJECT_DIR:-/cbica/home/wenju/Project/whole-body_clocks/mi_clock/fastGWA}"
