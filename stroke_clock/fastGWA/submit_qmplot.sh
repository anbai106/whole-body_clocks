...
# ============================================================
# Run qmplot for stroke disease L'EPOCH fastGWA results
#
# One Slurm array task = one disease-clock fastGWA result.
#
# Input pattern:
#   /cbica/home/wenju/Reproducibile_paper/WholeBodyClock/*_stroke_clock/fastGWA/output/*fastGWA
#
# Output:
#   /cbica/home/wenju/Reproducibile_paper/WholeBodyClock/<clock_folder>/fastGWA/qmplot/
#
# Recommended:
#   bash submit_qmplot_stroke.slurm
#
# Or directly:
#   sbatch submit_qmplot_stroke.slurm
# ============================================================
...
PROJECT_DIR="${PROJECT_DIR:-/cbica/home/wenju/Project/whole-body_clocks/stroke_clock/fastGWA}"
