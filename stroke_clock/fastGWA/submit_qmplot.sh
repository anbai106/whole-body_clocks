...
#SBATCH --job-name=qmplot_stroke
#SBATCH --array=0-11
#SBATCH --time=06:00:00
#SBATCH --mem-per-cpu=16G
#SBATCH --cpus-per-task=1
#SBATCH --output=/cbica/home/wenju/output/qmplot_stroke_%A_%a.out
#SBATCH --error=/cbica/home/wenju/output/qmplot_stroke_%A_%a.err
...
#   1. Change DISEASE below, e.g. DISEASE="stroke"
...
CLOCK_PREFIXES=(
  Brain_proteomics        Hepatic_metabolomics  Metabolic_metabolomics
  Digestive_metabolomics  Hepatic_proteomics    Pulmonary_proteomics
  Endocrine_metabolomics  Immune_metabolomics   Reproductive_female_proteomics
  Endocrine_proteomics    Immune_proteomics     Reproductive_male_proteomics
)
