...
### 7 proteomics  stroke clock
for organ in ['Brain', 'Hepatic', 'Endocrine', 'Immune', 'Pulmonary', 'Reproductive_female', 'Reproductive_male']:
    ...
    if col_name in clock_names:
        ...
        prepare_data(df, cov_tsv, output_dir, fastgwa_fam)
    else:
        raise Exception('Error...')

### 5 metabolomics  stroke clock
