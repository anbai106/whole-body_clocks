...
numbers=(Brain Hepatic Endocrine Immune Pulmonary Reproductive_female Reproductive_male)
...
if [[ -f ${output_file}.fastGWA ]]; then
  ...
  bash /cbica/home/wenju/Project/whole-body_clocks/stroke_clock/fastGWA/4_runGWAS/run.sh $output_dir $bfile $sparse_grm $pheno $output_file
fi