...
#SBATCH --job-name=brain_mri_stroke_clock
#SBATCH --mem-per-cpu=24G
#SBATCH --time=0-13:59:00
#SBATCH --output=/cbica/home/wenju/output/brain_mri_stroke_clock_%A.out
#SBATCH --error=/cbica/home/wenju/output/brain_mri_stroke_clock_%A.err
...
outdir="/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/brain_mri_stroke_clock"
mkdir -p "${outdir}"
mkdir -p /cbica/home/wenju/output

# Keep an organ-specific copy of the log inside the output folder.
exec > "${outdir}/brain_mri_stroke_clock_${SLURM_JOB_ID}.out" \
     2> "${outdir}/brain_mri_stroke_clock_${SLURM_JOB_ID}.err"

echo "============================================================"
echo "Starting brain MRI stroke L'EPOCH clock"
echo "SLURM_JOB_ID: ${SLURM_JOB_ID}"
echo "Output directory: ${outdir}"
echo "Started at: $(date)"
echo "============================================================"

python /cbica/home/wenju/Project/whole-body_clocks/stroke_clock/MRI/brain_mri_clock.py \
...
echo "============================================================"
echo "Finished brain MRI stroke L'EPOCH clock"
