...
#SBATCH --array=0-5
#SBATCH --output=/cbica/home/wenju/output/organ_mri_stroke_clock_%A_%a.out
#SBATCH --error=/cbica/home/wenju/output/organ_mri_stroke_clock_%A_%a.err
...
outdir="/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/${organ}_mri_stroke_clock"
mkdir -p "${outdir}"

# Redirect main job log dynamically into each organ-specific output folder
exec > "${outdir}/${organ}_mri_stroke_clock_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" \
     2> "${outdir}/${organ}_mri_stroke_clock_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err"

echo "============================================================"
echo "Starting organ MRI stroke clock"
echo "Organ: ${organ}"
...
python /cbica/home/wenju/Project/whole-body_clocks/stroke_clock/MRI/organ_mri_clock.py \
...
echo "============================================================"
echo "Finished organ MRI stroke clock"
echo "Organ: ${organ}"
