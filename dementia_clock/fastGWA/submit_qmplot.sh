...
CLOCK_PREFIXES=(
    Brain_proteomics        Heart_proteomics      Metabolic_metabolomics
    Digestive_metabolomics  Hepatic_metabolomics  Reproductive_female_proteomics
    Endocrine_metabolomics  Hepatic_proteomics    Reproductive_male_proteomics
    Endocrine_proteomics    Immune_proteomics
)
