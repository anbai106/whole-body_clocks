...
#SBATCH --job-name=organ_proteomics_dementia_clock
#SBATCH --mem-per-cpu=24G
#SBATCH --array=0-10
#SBATCH --output=/cbica/home/wenju/output/organ_proteomics_dementia_clock_%A_%a.out
#SBATCH --error=/cbica/home/wenju/output/organ_proteomics_dementia_clock_%A_%a.err
...
outdir="/cbica/home/wenju/Reproducibile_paper/WholeBodyClock/${organ}_proteomics_dementia_clock"
mkdir -p "${outdir}"
mkdir -p /cbica/home/wenju/output

# Redirect main job log dynamically into each organ-specific output folder
exec > "${outdir}/${organ}_proteomics_dementia_clock_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" \
     2> "${outdir}/${organ}_proteomics_dementia_clock_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err"

echo "============================================================"
echo "Starting organ proteomics dementia clock"
echo "Organ: ${organ}"
...
python /cbica/home/wenju/Project/whole-body_clocks/dementia_clock/Proteomics/organ_proteomics_dementia_clock.py \
  ...
  --outdir "${outdir}" \
  --organ "${organ}" \
  --omics-session-id 0_0

echo "============================================================"
echo "Finished organ proteomics dementia clock"
echo "Organ: ${organ}"
